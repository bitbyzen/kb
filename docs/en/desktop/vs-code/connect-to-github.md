...
2. Click **Allow** when the following dialog appears:
    ...
    ![Screenshot](img/connect-to-github-01.webp)

3. Click **Authorize Visual Studio Code** in your browser.

    ![Screenshot](img/connect-to-github-02.webp)

4. Click **Open Visual Studio Code**.

    ![Screenshot](img/connect-to-github-03.webp)

5. Close the browser page.

    ![Screenshot](img/connect-to-github-04.webp)
