...
![Screenshot](img/lock-drive-using-bitlocker-01.webp)

## Steps

1. Right-click the drive (for example **D:**), then select **Turn on BitLocker**.

    ![Screenshot](img/lock-drive-using-bitlocker-02.webp)

2. Enter a password to unlock the drive.

    ![Screenshot](img/lock-drive-using-bitlocker-03.webp)

3. Select **Save to your Microsoft account** to store the recovery key.

    ![Screenshot](img/lock-drive-using-bitlocker-04.webp)

4. Select **Encrypt used disk space only**.

    ![Screenshot](img/lock-drive-using-bitlocker-05.webp)

5. Select **New encryption mode**.

    ![Screenshot](img/lock-drive-using-bitlocker-06.webp)

6. Click **Start encrypting**.

    ![Screenshot](img/lock-drive-using-bitlocker-07.webp)

7. Click **Close** after the encryption is complete.

    ![Screenshot](img/lock-drive-using-bitlocker-08.webp)
