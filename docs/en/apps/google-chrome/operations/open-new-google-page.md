...
![Screenshot](open-new-google-page-01.webp)
...
3. Install the extension named **New Tab Redirect**.
      ...
      ![Screenshot](open-new-google-page-02.webp)

4. Click the **New Tab Redirect** extensions icon, then **Options**.

      ![Screenshot](open-new-google-page-03.webp)

5. Enter the following URL and click **Save**:  
   https://www.google.com/

      ![Screenshot](open-new-google-page-04.webp)
