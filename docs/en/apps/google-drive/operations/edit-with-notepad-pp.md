...
1. Open the Google Drive for desktop download page.
    ...
    ![Screenshot](edit-with-notepad-pp-01.webp)

2. Click **Download for Windows**.

    ![Screenshot](edit-with-notepad-pp-02.webp)

3. Run the installer.

4. In the installer window, click **Install**.

    ![Screenshot](edit-with-notepad-pp-03.webp)

5. Click **Sign in**.

    ![Screenshot](edit-with-notepad-pp-04.webp)

6. Select folders to sync.

    ![Screenshot](edit-with-notepad-pp-05.webp)

7. Click **Skip** to disable optional backups.

    ![Sceenshot](edit-with-notepad-pp-06.webp)

8. Click **Open Drive**.

    ![Screenshot](edit-with-notepad-pp-07.webp)
...
2. Click **Google Drive (G:)**, then **My Drive**.
    ...
    ![Screenshot](edit-with-notepad-pp-08.webp)

3. Navigate to the folder containing your `.md` file.

    ![Screenshot](edit-with-notepad-pp-09.webp)
