...
**Headings:** One H1 per document (title only). Use H2 for major sections, H3 for subsections. Title case for H2 and H3 as well. For step headings, use a colon: `## Step 1: Install the Application` (not an em dash).
