...
1. Click **Obsidian Vault** in the lower-left corner.
    ...
    ![Screenshot](img/open-vault-folder-01.webp)

2. Click **Manage vaults**.

    ![Screenshot](img/open-vault-folder-02.webp)

3. Locate the vault path shown at the top.

    ![Screenshot](img/open-vault-folder-03.webp)

4. Click **Open** under **Open folder as vault**.

    ![Screenshot](img/open-vault-folder-04.webp)

5. Select the folder named **Obsidian Vault**.

    ![Screenshot](img/open-vault-folder-05.webp)