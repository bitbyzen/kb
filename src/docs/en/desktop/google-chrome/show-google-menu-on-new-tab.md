# Showing the Google Menu on a New Tab
...
![Screenshot](img/show-google-menu-on-new-tab-01.webp)
...
3. Install the extension named **New Tab Redirect**.
      ...
      ![Screenshot](img/show-google-menu-on-new-tab-02.webp)

4. Click the **New Tab Redirect** extensions icon, then **Options**.

      ![Screenshot](img/show-google-menu-on-new-tab-03.webp)

5. Enter the following URL and click **Save**:  
   https://www.google.com/

      ![Screenshot](img/show-google-menu-on-new-tab-04.webp)
