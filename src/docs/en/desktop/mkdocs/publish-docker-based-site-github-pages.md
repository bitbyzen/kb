# Publishing a Docker-Based Site to GitHub Pages
...
2. Click **New** to create a repository.
    ...
    ![Screenshot](img/publish-docker-based-site-github-pages-01.webp)
...
3. Set the following options:
    ...
    ![Screenshot](img/publish-docker-based-site-github-pages-02.webp)

4. The repository is created.

    ![Screenshot](img/publish-docker-based-site-github-pages-03.webp)
...
3. Add the following content:
      ...
      ```
    ![Screenshot](img/publish-docker-based-site-github-pages-06.webp)
...
5. Open the **Actions** tab and confirm that the workflow completes successfully (green ✅).
    ...
    ![Screenshot](img/publish-docker-based-site-github-pages-07.webp)

## 5) Enable GitHub Pages (use GitHub Actions as the source)

1. Go to **Settings > Pages**.

    ![Screenshot](img/publish-docker-based-site-github-pages-04.webp)

2. Under **Build and deployment > Source**, select **GitHub Actions**.

    ![Screenshot](img/publish-docker-based-site-github-pages-05.webp)
