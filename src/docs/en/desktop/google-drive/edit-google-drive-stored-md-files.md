# Editing Google Drive Stored MD Files with Notepad++
...
1. Open the Google Drive for desktop download page.
    ...
    ![Screenshot](img/edit-google-drive-stored-md-files-01.webp)

2. Click **Download for Windows**.

    ![Screenshot](img/edit-google-drive-stored-md-files-02.webp)

3. Run the installer.

4. In the installer window, click **Install**.

    ![Screenshot](img/edit-google-drive-stored-md-files-03.webp)

5. Click **Sign in**.

    ![Screenshot](img/edit-google-drive-stored-md-files-04.webp)

6. Select folders to sync.

    ![Screenshot](img/edit-google-drive-stored-md-files-05.webp)

7. Click **Skip** to disable optional backups.

    ![Sceenshot](img/edit-google-drive-stored-md-files-06.webp)

8. Click **Open Drive**.

    ![Screenshot](img/edit-google-drive-stored-md-files-07.webp)
...
2. Click **Google Drive (G:)**, then **My Drive**.
    ...
    ![Screenshot](img/edit-google-drive-stored-md-files-08.webp)

3. Navigate to the folder containing your `.md` file.

    ![Screenshot](img/edit-google-drive-stored-md-files-09.webp)
