...
![Viewport sidebar open, showing the Transform panel](img/install-mpfb-addon-09.png)

An **MPFB** tab appears among the sidebar's vertical tabs, confirming the add-on installed successfully.

![Viewport sidebar's MPFB tab open, listing Developer, Hair Editor, New human, and other MPFB tools](img/install-mpfb-addon-10.png)
