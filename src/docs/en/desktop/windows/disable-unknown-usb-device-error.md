# Disabling the Unknown USB Device Error Notification
...
![Unknown USB Device error notification](img/disable-unknown-usb-device-error-02.png)

![Unknown USB Device error notification detail](img/disable-unknown-usb-device-error-03.png)
...
2. Right-click **Unknown USB Device** and select **Disable device**.
    ...
    ![Disable device option in Device Manager](img/disable-unknown-usb-device-error-01.png)
